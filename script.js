...
function getPrizeIndexBasedOnProbability() {
    ...
    const probabilities = [
        ...
        0.049, // Вероятность для Приз 2
        0.10, // Вероятность для Приз 3
        0.1,
        0.10, // Вероятность для Приз 5
        0.10, // Вероятность для Приз 6
        0.05, // Вероятность для Приз 7
        0.3, // Вероятность для Приз 8
        0.10, // Вероятность для Приз 9
        0.10, // Вероятность для Приз 10 (Банкрот)
    ];
